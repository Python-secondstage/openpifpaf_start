...
predictions, gt_arms, meta = predictor.numpy_image(img)
index = predictions[0].keypoints.index("left_shoulder")
# print(index)
# # print(predictions[0].data[5])
# # print(predictions[0].keypoints[5])
...
for pred in predictions:
    ...
    cv2.line(img, pt1=center_shoulder, pt2=center_hip, radius=5, color=(255, 0, 0), thickness=3)
